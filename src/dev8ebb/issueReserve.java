...
public class issueReserve implements IAutoConst{
	static
	{
	...
	@Test
	public void issueReserve() throws InterruptedException, FileNotFoundException, IOException, EncryptedDocumentException, InvalidFormatException 
	{
...
//	public static void main(String[] args) throws InterruptedException
	...
	driver.findElement(By.id("edit-pass")).sendKeys(username);
