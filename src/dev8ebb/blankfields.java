...
public class blankfields implements IAutoConst {
		...
		WebDriver driver=new ChromeDriver();
		 @Test (priority = 2)
		public void blankfields() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, FileNotFoundException, IOException 
		{
...
//				driver.findElement(By.id("edit-field-donor-registration-id-0-value")).sendKeys(dd1);
	...
	//	wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='edit_field_blood_group_chosen']")));
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@value='Save']")));
		driver.findElement(By.xpath("//button[@value='Save']")).click();

		
		System.out.println("please enter the registration ID" + "please enter the valid donar name " + " please enter the valid blood group" );
