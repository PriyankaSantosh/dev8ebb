...
public class Hb implements IAutoConst {
	static
	{
	...
	@Test
	public void Hb() throws InterruptedException, FileNotFoundException, IOException, EncryptedDocumentException, InvalidFormatException 
	{
...
//driver.findElement(By.xpath("//*[@id=\\\"ui-id-6\\\"]/span/span")).click();
	...
	driver.findElement(By.xpath("//button[@id='edit-submit']")).click();
	System.out.println("The donor has less than required hemoglobin and is therefore ineligible.");
}
}