...
import org.omg.CORBA.TIMEOUT;
	...
	public class End implements IAutoConst{
		static
		{
		...
		@Test
		public void CreatePatientBillWithoutAddingItem() throws InterruptedException, FileNotFoundException, IOException, EncryptedDocumentException, InvalidFormatException 
		{
	...
	*/
	...
	driver.findElement(By.xpath("//select[@id='edit-field-patient-bill-type']")).click();
	driver.findElement(By.xpath("//option[@value='Item']")).click();
	driver.findElement(By.xpath("//select[@id='edit-field-bill-unit-item']")).click();
