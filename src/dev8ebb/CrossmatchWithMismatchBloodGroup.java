...
public class CrossmatchWithMismatchBloodGroup implements IAutoConst {
	static
	{
	...
	@Test
	public void CrossmatchWithMismatchBloodGroup() throws InterruptedException, FileNotFoundException, IOException, EncryptedDocumentException, InvalidFormatException 
	{
...
driver.findElement(By.xpath("//button[@id='edit-submit']")).click();
System.out.println("crossmatch with mismatch blood group");
