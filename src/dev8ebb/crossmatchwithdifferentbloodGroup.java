...
public class crossmatchwithdifferentbloodGroup implements IAutoConst {
	static
	{
	...
	@Test
	public void crossmatchwithdifferentbloodGroup() throws InterruptedException, FileNotFoundException, IOException, EncryptedDocumentException, InvalidFormatException 
	{
...
*/
	...
	driver.findElement(By.xpath("//li[text()='A2 Neg']")).click();
...
driver.manage().timeouts().implicitlyWait(90,TimeUnit.SECONDS);
	...
	driver.findElement(By.xpath("//select[@data-drupal-selector='edit-field-crossmatch-exchange-unit']")).click();
	driver.findElement(By.xpath("(//option[@value='2'])[1]")).click();
	
driver.findElement(By.xpath("//button[@id='edit-submit']")).click();
System.out.println("crossmatch with different blood group mark as exchange transfusion should allow to issue");
